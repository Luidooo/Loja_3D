...
def calcula_volume_cilindro(diametro, altura):
    return math.pi * (diametro/2)**2 * altura

def calcula_volume_circulo(diametro):
...
def main():
    ...
    if forma_selecionada == "Ambos":
        ...
        volume_cilindro = calcula_volume_cilindro(diametro_cilindro, altura_cilindro)
        volume_circulo = calcula_volume_circulo(diametro_circulo)
        ...
        volume_total = calcula_volume_cilindro(diametro_cilindro, altura_cilindro)
    else:
        diametro_circulo = st.number_input("Diametro (cm):", min_value=0.1, step=0.1)

        # Calcula o volume apenas para o círculo
        volume_total = calcula_volume_circulo(diametro_circulo)
    ...
    st.write("Taxa da Hora da Máquina:")
